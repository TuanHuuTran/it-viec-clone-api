-- CreateEnum
CREATE TYPE "RoleType" AS ENUM ('ADMIN', 'EMPLOYER', 'CANDIDATE', 'MODERATOR', 'VISITOR');
...
-- CreateIndex
CREATE INDEX "role_users_userId_idx" ON "role_users"("userId");

-- CreateIndex
CREATE INDEX "role_users_roleId_idx" ON "role_users"("roleId");
